...
const MainNavigationContent = () => {
	...
	const fetchPages = async () => {
		try {
			setLoading(true)
			const response = await axios.get(`${BASE_URL}/api/pages/MainCon`)
		...
		<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
			<div className="mx-auto">
				...
				<div className="text-center mb-8">
					<h1 className="text-3xl font-bold text-gray-800 mb-2">Navigatsiyaga Ma'lumot Qo'shish</h1>
					<p className="text-gray-600">Tanlangan navigatsiya bo'yicha kontentlarni boshqaring</p>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
					...
					<div className="lg:col-span-1">
						<div className="bg-white rounded-xl shadow-lg p-6">
							<h2 className="text-lg font-semibold text-gray-800 mb-4">Asosiy Navigatsiyalar</h2>
					...
					<div className="lg:col-span-3">
						{!selectedPage ? (
							<div className="bg-white rounded-xl shadow-lg p-8 text-center">
								...
								<p className="text-gray-600">Kontent qo'shish uchun chap tomondan navigatsiyani tanlang</p>
							</div>
						) : (
