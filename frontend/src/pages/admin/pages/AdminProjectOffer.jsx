...
const AdminProjectOffer = () => {
	...
	// Fetch all offer projects
	const fetchProjects = async () => {
		setLoading(true)
		try {
			const response = await axios.get(`${baseURL}/api/project/getAll/offer`)
	...
	const handleEdit = (project) => {
		setFormData({
			...
			prossesing: project.prossesing || 'offer'
		})
				...
				<div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
					<div className="mb-6 lg:mb-0">
						<h1 className="text-3xl font-bold text-gray-800 mb-2">
							Taklif Etilyotgan Loyihalar
						</h1>
						<p className="text-gray-600">
							Taklif qilinayotgan loyihalar ma'lumotlarini boshqaring
						</p>
					</div>
					<button
							...
							<table className="min-w-full divide-y divide-gray-200">
								...
								<tbody className="bg-white divide-y divide-gray-200">
									{filteredProjects.map((project, index) => (
										<tr key={project._id} className="hover:bg-blue-50 transition-colors duration-200">
											{/* Number */}
					...
					<div className="bg-white rounded-2xl shadow-lg p-8 text-center">
						<div className="max-w-md mx-auto">
							...
							<h3 className="text-xl font-semibold text-gray-700 mb-2">
								{searchTerm ? 'Qidiruv bo\'yicha hech narsa topilmadi' : 'Hozircha taklif etilyotgan loyihalar mavjud emas'}
							</h3>
							<p className="text-gray-500 mb-6">
								{searchTerm ? 'Boshqa so\'zlar bilan qayta urinib ko\'ring' : 'Birinchi taklif etilyotgan loyihani qo\'shish uchun "Yangi Loyiha Qo\'shish" tugmasini bosing'}
							</p>
							{!searchTerm && (
								<button
...
export default AdminProjectOffer